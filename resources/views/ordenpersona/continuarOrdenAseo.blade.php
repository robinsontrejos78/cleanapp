  ...
  <div class="col-md-6 col-md-offset-3">
    <div class="box box-danger">
      ...
      <div class="box-body">
        <div class="row">
          <div class="col-md-12">  
              <span class="badge bg-yellow btn-block" style="font-size:15px; margin-bottom:20px" data-toggle="tooltip" title="Por favor guarde las evidencias suficientes del servicio que está realizando">Evidencias de Aseo</span>
          </div>
        </div>
      ...
      <!-- <form method="post" action="" enctype="multipart/form-data" files="true" class="deshabilita" id="formulario"> -->
        ...
        <input type="hidden" name="ruta" value="continuarOrden">
        <input type="hidden" name="i_tipo" value="1" id="tipoNovedad">
        ...
        <div class="col-md-4 col-md-offset-2">
         ...
         <!-- <input type="submit" class="btn btn-primary btn-sm btn-block" style="margin-top:20px" value="Evidencias de Aseo"> -->
        </div>

   
        <div class="col-md-4"> 
          <a href="../checkoutOrden/{{ $orden->ORD_IDORDEN }}"  class="btn btn-danger btn-sm btn-block comprobar" style="margin-top:20px">Continuar</a>
        </div>
        <!-- </form> -->
