  ...
  <div class="col-md-12">
    <div class="box box-danger">
      ...
      <div class="box-header with-border">
        <h3 class="box-title">Buscar Usuarios <span class="badge bg-teal"  data-toggle="tooltip" title="Puede filtrar la busqueda por Nombre de empresa, Contacto o email" data-container="body"><i class="fa fa-fw fa-info-circle"></i></span></h3>
      </div>

      <div class="box-body">
        <div class="col-md-3">
          <label for="nombreUsu">Nombre</label>
          <input type="text" class="form-control" id="nombreUsu" placeholder="Nombre del Usuario">
        </div>
        <div class="col-md-3">
          <label for="apellidoUsu">Apellido</label>
          <input type="text" class="form-control" id="apellidoUsu" placeholder="apellido del Usuario">
        </div>
        <div class="col-md-3">
        ...
        <div class="col-md-3">
          <button style="margin-top:23px" type="button" id="buscarUsu" class="btn btn-primary" data-toggle="tooltip" title="Buscar" data-container="body">Buscar</button>
        </div>
      </div>
            ...
            <tbody>
              @foreach($users as $user)
                ...
                @endif
                  ...
                  <td class="centro">
                    <a class="btn btn-info btn-sm btn_modal" data-table="Usuario" data-show="show" data-id="{{ $user->id }}" role="button" data-toggle="tooltip" title="" data-placement="top" data-original-title="Ver Detalles" data-container="body"><span class="glyphicon glyphicon-search"></span></a>
