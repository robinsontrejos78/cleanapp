...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'nombreCon'    => 'Nombre de Contacto',
        'telefonoEmp'  => 'Teléfono de La empresa',
        'emailCon'     => 'Correo Electrónico de la Empresa',
        'nombreUsu'    => 'Nombres de usuario',
        'apellidoUsu'  => 'Apellidos de Usuario',
        'documentoUsu' => 'Documento de Usuario',
        'celularUsu'   => 'Celular de Usuario',
        'direccionUsu' => 'Dirección de Usuario',
        'emailUsu'     => 'Correo Electrónico',
        'passwordUsu'  => 'Contraseña',
        'empresaUsu'   => 'Empresa',
        'tipo_Inm'     => 'Tipo de Inmueble',
        'nombrePer'    => 'Nombre de la Persona',
        'apellidoPer'  => 'Apellido de la Persona',
        'celularPer'   => 'Celular de la Persona',
        'direccionPer' => 'Dirección de la Persona',
        'emailPer'     => 'Correo Electrónico de la Persona',
        'passwordPer'  => 'Password',
        'USR_DOCUMENTO'=> 'Documento de La persona',
        'tipoPer'      => 'Tipo de Persona',
        'ciudadPer'    => 'Ciudad de la persona',
        'generoPer'    => 'Género de la persona',
        'empresaUsu'   => 'Empresa',
        'nombreCiu'    => 'Nombre de la Ciudad',
